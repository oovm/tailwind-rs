...
fn test_flex_keyed() {
    ...
    std::fs::write("src/support/support_html/test/flex/flex.keyed.html", html.as_bytes()).unwrap();
    std::fs::write("src/support/support_html/test/flex/flex.keyed.css", css.as_bytes()).unwrap();
...
fn test_flex_value() {
    ...
    std::fs::write("src/support/support_html/test/flex/flex.value.html", html.as_bytes()).unwrap();
    std::fs::write("src/support/support_html/test/flex/flex.value.css", css.as_bytes()).unwrap();
